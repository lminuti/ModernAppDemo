...
begin
  TUIFactory.GetConcreteFactory.GetUIDocumento(FDataSet.FieldByName('TIPO').AsString);
end;
...
begin
  TUIFactory.GetConcreteFactory.GetUIDocumento(FDataSet.FieldByName('TIPO').AsString, FDataSet.FieldByName('ID').AsInteger);
end;
